...
var slashList = [
    new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName("regulamin")
                .setDescription("Wysyła regulamin dotyczący GlobalChata")
        )
            ...
            subcommand_group
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName("odblokuj")
                        .setDescription(
                            "Usuwa osobę z czarnej listy GlobalChata."
                        )
                        .addStringOption((option) =>
                            option
                                .setName("osoba")
                                .setDescription("ID osoby do odblokowania.")
                                .setRequired(true)
                        )
                )
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName("zablokuj")
                        .setDescription(
                            "Dodaje osoby do czarnej listy GlobalChata."
                        )
                        .addStringOption((option) =>
                            option
                                .setName("osoba")
                    ...
                    subcommand
                        ...
                        .addChannelOption((option) =>
                            option
                                .setName("kanał")
                                .setDescription(
                                    "Kanał, na którym ma się znajdować GlobalChat."
                                )
                                .setRequired(true)
    ...
    new SlashCommandBuilder()
        ...
        .setDMPermission(true)
        .setDescription(
            "Tworzy kod dający gradient w Minecraft; obsługuje typ JSON"
        )
        .addStringOption((option) =>
            option
                .setName("kolory")
                .setDescription(
                    "Kolory w gradiencie, kod HEX oddzielone spacją, np. #084CFB #ADF3FD"
                )
                .setRequired(true)
        )
        .addStringOption((option) =>
            option
                .setName("tekst")
                .setDescription("Tekst gradientowany")
                .setRequired(true)
        )
        .addStringOption((option) =>
            option
                .setName("typ")
                .setDescription("Typ zwracania tekstu")
                .setRequired(true)
                .addChoices(
        ...
        .addBooleanOption((option) =>
            option.setName("pogrubiony").setDescription("Opcja pogrubienia")
        )
        .addBooleanOption((option) =>
            option
                .setName("pochylony")
                .setDescription(
                    "Opcja pochylenia. DOMYŚLNIE W JSON JEST POCHYLONA"
                )
        )
        .addBooleanOption((option) =>
            option.setName("podkreślony").setDescription("Opcja podkreślenia.")
        )
        .addBooleanOption((option) =>
            option
                .setName("przekreślony")
